...
The disk format is \texttt{astrolabe.json} (semantic simplicial complex), graded by dimension as defined in \S\ref{sec:foundations}. In memory, the complex is loaded into a Hasse diagram with four indices:
