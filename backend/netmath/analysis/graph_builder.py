"""
Graph Builder: Convert NetMath Node/Edge to NetworkX graph
...
def build_networkx_graph(
    ...
    """
    Convert NetMath nodes and edges to a NetworkX graph.

    Args:
        nodes: List of NetMath Node objects
        edges: List of NetMath Edge objects
